...
export default () => {
    ...
    <div class="fakeimg" style="height:60px;">
        ...
        <div id="small-price" class="price">$8.93</div>
    </div><br>
    <div class="fakeimg" style="height:60px;">
        <div id="medium" class="medium">Medium</div>
        <div id="medium-price" class="price">$8.93</div>
    </div><br>
    <div class="fakeimg" style="height:60px;">
        <div id="large" class="large">Large</div>
        <div id="large-price" class="price">$8.93</div>
    </div><br>
    <div class="fakeimg" style="height:60px;">
        <div id="xlarge" class="xlarge">Extra Large</div>
        <div id="xlarge-price" class="price">$8.93</div>
    </div><br>
</div>`
}