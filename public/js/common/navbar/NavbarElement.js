...
paymentProcess() {
  ...
  if (path === '/shipping') {
      ...
      // placeOrder.setAttribute('href', 'https://wonderfulpizza.devoutprogrammer.com/review')
  ...
  if (path === '/payment') {
      ...
      placeOrder.style.display = 'inline-block'
      placeOrder.setAttribute('href', 'https://wonderfulpizza.devoutprogrammer.com/feedback')
  ...
  if (path === '/review') {
      ...
      placeOrder.innerHTML = `PAYMENT METHOD NEXT`
      placeOrder.style.display = 'inline-block'
      placeOrder.setAttribute('href', 'https://wonderfulpizza.devoutprogrammer.com/payment')
  }
  if (path === '/feedback') {
      this.navbarItems('none')
      ...
      placeOrder.setAttribute('href', 'https://wonderfulpizza.devoutprogrammer.com/menu')
  }
