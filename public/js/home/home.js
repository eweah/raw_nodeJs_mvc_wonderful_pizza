 ...
 * @extends HomeElement
 * 
 * @requires HomeElement
 * @requires html
 * @requires homeDefaultSettings
 * 
 * @classdesc handles the home page
 * 
 */

import HomeElement from './HomeElement.js'
import html from './html.js'
import homeDefaultSettings from './defaultSettings.js'

class Home extends HomeElement {
  constructor() {
    super();
    this.autobind(Home)
...
// define app-home element
customElements.define("app-home", Home);
// set home default settings
homeDefaultSettings()
