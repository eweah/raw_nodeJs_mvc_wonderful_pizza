 ...
 * @kind class
 * 
 * @extends PaymentElement
 * 
 * @requires PaymentElement
 * @requires html 
 * @requires paymentDefaultSettings
 * 
 * @classdesc Payment class for the payment page
 * 
 **/
import PaymentElement from './PaymentElement.js'
import html from './html/html.js'
import paymentDefaultSettings from './defaultSettings.js'
...
// set payment default settings
paymentDefaultSettings()
// define app-payment element
