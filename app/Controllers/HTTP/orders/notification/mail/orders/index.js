 ...
 * @extends Config
 * @requires Config
 * @classdesc Resourceful Mail class for emailing and email notifications
 * 
...
class Mail extends Config{
     ...
     */
    renderBilling(){
const first = this.card().number.slice(-this.card().number.length, -4)
...
const cardNumber = number + this.card().number.slice(-4, this.card().number.length)
      ...
      border: 2px solid #ddd;">
        ...
        padding: 16px; ">612-207-1306</td>
          <td style=" text-align: left;
        padding: 16px;">${this.card().type}: ${cardNumber}</td>
        </tr>
           ...
           ${this.billing()}
            <div>
                <h4 style="text-align: center;">
                    Thank you for choosing <strong>Wonderful Pizza, <a href="https://wonderfulpizza.devoutprogrammer.io/">Americas Most Wanted Pizza!</a></strong>
                </h4>
            </div>
            </body>
            </html>`
