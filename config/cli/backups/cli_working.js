...
class CLI extends Transform{
    ...
    addTo(array = []){
        this.autoinvoked().push(array)
    }
    autoinvoked(){
        return ['commands', 'login', 'common', 'notACommand', 'cliInterface', 'init']
    }
    ...
    regexes(){
        ...
        return {hregex, mregex, dregex, Mregex, yregex,Dregex, jsonregex, phoneregex}
    }
